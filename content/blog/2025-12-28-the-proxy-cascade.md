...
excerpt: >-
  While making the Finsense webapp we used a free zero api solution where we
  didn't use any costly api to fetch news rather we fetched news directly from
  the frontend but this had a major issue.
---
